    ...
    >
      <div className="flex items-center justify-between pb-3.5 mb-4 border-b border-slate-800/80">
        <div className="flex items-center gap-2.5">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-sky-600/20 text-sky-400 border border-sky-500/30 shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-xs sm:text-sm text-slate-300 hover:text-sky-400 py-1.5 px-2.5 rounded-lg bg-slate-800/80 hover:bg-slate-700 transition"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
        ...
        <div>
          <label
            ...
            className="flex items-center gap-1.5 text-xs sm:text-sm font-bold uppercase tracking-wider text-slate-200 mb-1.5"
          >
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-700 bg-slate-950 px-3.5 py-3 text-base text-slate-100 placeholder:text-slate-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 transition"
          />
        </div>
        ...
        <div>
          ...
          >
            ...
            <span className="text-slate-400 font-medium text-xs">(CC Copy)</span>
          </label>
          <input
        ...
        <div className="md:col-span-2">
          ...
          >
            ...
            <span className="text-emerald-400 font-medium text-xs">(Auto-populated)</span>
          </label>
          <input
            ...
            className="w-full rounded-xl border border-slate-700 bg-slate-950 px-3.5 py-3 text-base text-slate-200 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 transition"
          />
        </div>
      </div>
    </div>
